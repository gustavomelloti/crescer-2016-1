...
describe('Ex 3. Instrutor querido', function() {
  window.imprimeInstrutor = function(instrutor) {
   console.log('olá querido instrutor:', instrutor)
  }

  beforeEach(function() {
    spyOn(window, 'imprimeInstrutor');
  });
  ...
  it('quando informa função imprimir no console para todos instrutores', function() {
    ...
    // Act
    imprime(instrutores, imprimeInstrutor);
    // Assert
    expect(imprimeInstrutor.calls.count()).toBe(5);
    instrutores.forEach(function(i) {
      expect(imprimeInstrutor).toHaveBeenCalledWith(i);
    });
  });
  ...
  it('quando informa função imprimir no console para array vazio', function() {
    ...
    imprime(instrutores, imprimeInstrutor);
    // Assert
    expect(imprimeInstrutor.calls.count()).toBe(0);
  });
  ...
  it('quando informa função imprimir no console para um instrutor', function() {
    ...
    imprime(instrutores, imprimeInstrutor);
    // Assert
    expect(imprimeInstrutor.calls.count()).toBe(1);
    expect(imprimeInstrutor).toHaveBeenCalledWith(instrutores[0]);
  });
